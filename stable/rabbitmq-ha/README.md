...
| `persistence.enabled`                     | If `true`, persistent volume claims are created                                                                                                                                                       | `false`                                                    |
| `persistence.name`                        | Persistent volume name                                                                                                                                                                                | `data`                                                     |
...
| `rabbitmqMemoryHighWatermark`                  | Memory high watermark                                                                                                                                                                                 | `0.4`                                                    |
| `rabbitmqMemoryHighWatermarkType`              | Memory high watermark type. Either absolute or relative                                                                                                                                               | `relative`                                                 |
