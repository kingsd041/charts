...
{{- default .Chart.Name .Values.influxdb_relay.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- if .Values.influxdb_relay.fullnameOverride -}}
{{- .Values.influxdb_relay.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
